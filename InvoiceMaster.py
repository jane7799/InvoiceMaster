...
from PyQt6.QtGui import QPixmap, QImage, QPainter, QColor, QPen, QFont, QIcon, QDragEnterEvent, QDropEvent, QPalette, QBrush, QTransform
...
class AboutDialog(QDialog):
    def __init__(self, parent):
        ...
        qr_layout.addWidget(make_qr("qr1.jpg", "打赏", "💰"))
        qr_layout.addWidget(make_qr("qr2.jpg", "加好友", "👋"))
